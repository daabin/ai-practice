...
export default function SignupPage() {
  ...
  return <div className="w-2/3">
    ...
    <p className="mt-2 text-base text-gray-600">{t('tipLogin')} <Link href="/login" title="" className="font-medium text-green-600 transition-all duration-200 hover:text-green-700 focus:text-green-700 hover:underline">{t('tipToLogin')}</Link></p>
