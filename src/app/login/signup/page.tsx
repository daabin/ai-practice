...
export default function SignupPage() {
  return <div className="w-2/3">
    <h2 className="text-3xl font-bold leading-tight text-black">注册</h2>
    <p className="mt-2 text-base text-gray-600">已有账号? <Link href="/login" title="" className="font-medium text-green-600 transition-all duration-200 hover:text-green-700 focus:text-green-700 hover:underline">前往登录</Link></p>
